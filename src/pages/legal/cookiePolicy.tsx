...
const cookiePolicy = () => {
    ...
    return (
            <main className="privacy-policy-container">
                ...
                <section>
                    <p>
                        This Cookie Policy explains how WolexChange ("<strong>Company</strong>,"
                ...
                <section>
                    ...
                    <p>
                        Cookies set by the website owner (in this case, WolexChange) are called
