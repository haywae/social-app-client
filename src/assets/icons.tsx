 ...
 * This component acts as a base wrapper for all other icons, providing default SVG properties
...
export const Icon = ({ children, className, ...rest }: IconProps) => {
  return (
    <svg
      ...
      strokeWidth={1}
      stroke="currentColor"
      className={`svg-icon ${className || ''}`} // Combine the default class with any class passed in as a prop
      data-testid="icon-base"
      {...rest} // Pass any other SVG props like width, height, etc.
    >
      {children} {/* The <path> */}
    </svg>
  );
...
export const MenuIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <Icon className="menu-icon" {...props}>
...
export const SearchIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <Icon className="search-icon" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="m21 21-5.197-5.197m0 0A7.5 7.5 0 1 0 5.196 5.196a7.5 7.5 0 0 0 10.607 10.607Z" />
  </Icon>
);

/** Renders a notification icon. */
export const NotificationIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <Icon className="notification-icon" {...props}>
...
export const HomeIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <Icon className="home-icon" {...props}>
...
export const ProfileIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <Icon className="profile-icon" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M17.982 18.725A7.488 7.488 0 0 0 12 15.75a7.488 7.488 0 0 0-5.982 2.975m11.963 0a9 9 0 1 0-11.963 0m11.963 0A8.966 8.966 0 0 1 12 21a8.966 8.966 0 0 1-5.982-2.275M15 9.75a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
  </Icon>
);

/** Renders a create post icon. */
export const CreatePostIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <Icon className="create-post-icon" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 4.5v15m7.5-7.5h-15" />
    {/*d="M12 20v-6m0-6V2m-6 12H2m6 0h4m8 0h-2m-6-6h6m-6 6h6"*/}
  </Icon>
)

/** Renders a close icon. */
export const CloseIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <Icon className="close-icon" {...props}>
...
export const SettingsIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <Icon className="settings-icon" {...props}>
...
export const CalendarIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <Icon className="calendar-icon" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 0 1 2.25-2.25h13.5A2.25 2.25 0 0 1 21 7.5v11.25m-18 0A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75m-18 0h18M12 12.75h.008v.008H12v-.008Zm0 3h.008v.008H12v-.008Zm.375-3h.008v.008h-.008v-.008Zm0 3h.008v.008h-.008v-.008Zm-3.375-3h.008v.008h-.008v-.008Zm0 3h.008v.008h-.008v-.008Zm-3 3.75h.008v.008h-.008v-.008Zm0-3h.008v.008h-.008v-.008Zm0-3h.008v.008h-.008v-.008Zm3 .008h.008v.008h-.008v-.008Zm3 0h.008v.008h-.008v-.008Zm3-3h.008v.008h-.008v-.008Zm-3 3h.008v.008h-.008v-.008Z" />
  </Icon>
);

/** Renders a bank note icon. */
export const BankNoteIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <Icon className="bank-note-icon" {...props}>
...
export const RefreshIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <Icon className="refresh-icon" {...props}>
...
export const CopyIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <Icon className="copy-icon" {...props}>
...
export const RightArrowIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <Icon className="right-arrow-icon" {...props}>
...
export const LeftArrowIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <Icon className="left-arrow-icon" {...props}>
...
export const EditIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <Icon className="edit-icon" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L10.582 16.07a4.5 4.5 0 0 1-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 0 1 1.13-1.897l8.932-8.931Zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0 1 15.75 21H5.25A2.25 2.25 0 0 1 3 18.75V8.25A2.25 2.25 0 0 1 5.25 6H10" />
  </Icon>
)

export const FollowIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <Icon className="follow-icon" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M18 7.5v3m0 0v3m0-3h3m-3 0h-3m-2.25-4.125a3.375 3.375 0 1 1-6.75 0 3.375 3.375 0 0 1 6.75 0ZM3 19.235v-.11a6.375 6.375 0 0 1 12.75 0v.109A12.318 12.318 0 0 1 9.374 21c-2.331 0-4.512-.645-6.374-1.766Z" />
  </Icon>
)

export const UnfollowIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <Icon className="unfollow-icon" {...props}>
...
export const TrashIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <Icon className="trash-icon" {...props}>
...
export const SignoutIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <Icon className="signout-icon" {...props}>
...
export const ShareIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <Icon className="share-icon" {...props}>
...
export const ViewIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <Icon className="view-icon" {...props}>
...
export const AlertTriangleIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <Icon className="alert-triangle-icon" {...props}>
...
export const CheckBadgeIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <Icon className="check-badge-icon" {...props}>
...
export const MentionIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <Icon className="mention-icon" {...props}>
...
export const MessageOpenIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <Icon className="message-open-icon" {...props}>
...
export const MessageIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <Icon className="message-icon" {...props}>
